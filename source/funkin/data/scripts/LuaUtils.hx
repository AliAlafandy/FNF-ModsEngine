...
class LuaUtils
{
	public static final Function_Stop:Dynamic = "##SCRIPTLUA_FUNCTIONSTOP";
	public static final Function_Continue:Dynamic = "##SCRIPTLUA_FUNCTIONCONTINUE";
	public static final Function_StopLua:Dynamic = "##SCRIPTLUA_FUNCTIONSTOPLUA";
	public static final Function_StopHScript:Dynamic = "##SCRIPTLUA_FUNCTIONSTOPHSCRIPT";
	public static final Function_StopAll:Dynamic = "##SCRIPTLUA_FUNCTIONSTOPALL";

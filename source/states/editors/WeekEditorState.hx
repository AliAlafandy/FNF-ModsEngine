...
class WeekEditorState extends MusicBeatState
{
	...
	function reloadBG() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			Assets.exists(Paths.getPath('images/menubackgrounds/menu_' + assetName + '.png', IMAGE), IMAGE) || Paths.getPath('images/menubackgrounds/menu_' + assetName + '.astc', BINARY), BINARY) {
	...
	function reloadWeekThing() {
		...
		if(isMissing) {
			...
			missingFileText.text = 'MISSING FILE: images/storymenu/' + assetName + '.png/.astc';
		}
